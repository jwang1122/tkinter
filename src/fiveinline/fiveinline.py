...
class Board(Canvas):
    def __init__(self, parent, width=600, height=480):
        ...
        self.whitewinImg = PhotoImage(file='src/images/whitewin.png')
    ...
    def clicked(self, event):
        ...
        win= self.fiveInLine()
        if win: self.gameOver()
        # self.t1 = self.t
        
    def fiveInLine(self):
        return self.checkAllRows() or self.checkAllColumns() or self.checkBackSlash() or self.checkForwardSlash()
    ...
    def gameOver(self):
        ...
        if self.winner=='Black':
            ...
            self.create_image(300, 235, image=self.whitewinImg)
