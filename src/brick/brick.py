...
class Rect:
    def __init__(self, i, j, width, height, color, canvas):
        self.left, self.top = i*width, j*height
        self.width, self.height = width, height
        self.item = canvas.create_rectangle(self.left, self.top, self.left+self.width, top+height, fill=color)
        self.canvas = canvas
...
class Brick:
    ...
    def __init__(self, canvas, i, j, color):
        self.canvas = canvas
        self.left, self.top = i, j
